...
val draconic_staff_of_power = RecipeBuilder.newBuilder("draconic_staff_of_power","the_last_forge",1);
draconic_staff_of_power.addEnergyPerTickInput(25000000);
draconic_staff_of_power.addFluidInput(<liquid:glowstone>*5000);
draconic_staff_of_power.addFluidInput(<liquid:redstone>*5000);
draconic_staff_of_power.addAspectInput("energy",250);
draconic_staff_of_power.addAspectInput("day",250);
draconic_staff_of_power.addAspectInput("night",250);
draconic_staff_of_power.addItemInput(<draconicevolution:draconic_staff_of_power>.withTag({Profile_0: {showDigAOE: 0 as byte, digDepth: 0, digSpeed: 100, aoeSafeMode: 0 as byte, digAOE: 0, attackAOE: 2.0, junkNbtSens: 1 as byte, enableJunkFilter: 1 as byte}}));
draconic_staff_of_power.addItemOutput(<draconicevolution:draconic_staff_of_power>.withTag({RepairCost: 0, display: {Name: "Посох Силы"}, Profile_0: {showDigAOE: 0 as byte, digDepth: 0, digSpeed: 100, aoeSafeMode: 0 as byte, digAOE: 0, attackAOE: 2.0, junkNbtSens: 1 as byte, enableJunkFilter: 1 as byte}}));
draconic_staff_of_power.build();
...
ffsword.addItemOutput(<contenttweaker:sword6>.withTag({ench: [{lvl: 25, id: 21}], HideFlags: 2, AttributeModifiers: [{UUIDMost: 4063, UUIDLeast: 721355, Amount: 75, AttributeName: "generic.maxHealth", Operation: 0, Name: "generic.maxHealth"}, {UUIDMost:20819, UUIDLeast:964349, Amount:60, AttributeName: "generic.attackDamage",Operation: 0, Name:"generic.attackDamage"}]}));
ffsword.build();
